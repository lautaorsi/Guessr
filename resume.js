...
const text = {'es': {'wow': 'Bien jugado!','nicetry': 'Buen intento!','betterluck':'Mejor suerte la proxima!','points':`Obtuviste ${objscore} Puntos`}, 'en':{'wow':'Wow!','nicetry':'Well played!','betterluck':'Better luck next time!','points':`You got ${objscore} Points`}}
